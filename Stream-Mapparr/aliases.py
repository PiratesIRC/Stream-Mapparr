...
CHANNEL_ALIASES = {
    ...
    "Showtime (E)": [
        ...
        "Paramount+ with Showtime HD",
        "Showtime East",
        "Showtime",
    ],
    "Showtime (W)": [
        "Paramount+ with Showtime (Pacific)",
        "Paramount+ with Showtime HD (Pacific)",
        "Showtime West",
    ],
    ...
    "Daystar": [
        ...
        "Daystar Television Network HD",
    ],
    "TBN": [
        "TBN",
        "Trinity Broadcasting Network",
        "Trinity Broadcasting Network HD (TBN)",
    ],
